...
we can run tsc and a ts file name and it will convert that file to a js file (example.ts/example.js)
if se set the rootDir of our project to a folder of TS files running tsc
will compile all the files into JS files.tsc -
...
function getEvenIndices(_, index) {
    return index % 2 === 0;
}
...
Default: true
Recommended: true ( !!! Brian changed it to false !!! )
...
//     action(){ // (add override) override action(){
...
// import {squareFootage} from './area';
// let myArea3=squareFootage(1,2) // parameters gotta be number as specified previously
// console.log(myArea3)
/*
